...
@section('content')
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <div class="text-center mb-16">
            <div
                class="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-emerald-100 text-emerald-800 text-sm font-medium mb-6">
        ...
        <div class="sticky top-20 bg-white border-b border-stone-200 py-4 z-10 mb-8">
            <div class="flex overflow-x-auto space-x-4 pb-2 scrollbar-hide">
                <a href="#info-collection"
                    class="flex-shrink-0 text-sm text-stone-600 hover:text-emerald-700 whitespace-nowrap">
        ...
        <div class="max-w-4xl mx-auto">
            ...
            <div class="mb-12">
                <p class="text-lg text-stone-700 leading-relaxed">
                    Welcome to {{ \App\Helpers\SettingsHelper::get('store_name', 'Ved Herbs & Ayurveda') }}. Your privacy is
                    extremely important to us, and we are committed to protecting the personal information you share with us
                    while using our website.
                </p>
                <p class="text-lg text-stone-700 leading-relaxed mt-4">
                    This Privacy Policy explains how we collect, use, store, protect, and disclose your information when you
            ...
            <section id="info-use" class="mb-16 scroll-mt-20">
                ...
                <div class="grid md:grid-cols-2 gap-4">
                    ...
                    <div class="bg-white border border-stone-200 rounded-xl p-5 hover:border-purple-300 transition-colors">
                        ...
                        <p class="text-sm text-stone-600">To send promotional offers, updates, and newsletters (with
                            consent)</p>
                    </div>
            ...
            <section id="cookies" class="mb-16 scroll-mt-20">
                ...
                <div class="space-y-4">
                    <div class="flex items-start gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-stone-600">Store your language, currency, and other preferences for future visits
                            </p>
                        </div>
                    </div>
                ...
                <div class="mt-8 p-5 bg-white border border-stone-200 rounded-xl">
                    <div class="flex items-start gap-3">
                        <iconify-icon icon="lucide:info" width="20"
                            class="text-amber-600 mt-0.5 flex-shrink-0"></iconify-icon>
                        <div>
                            <p class="text-stone-700">
                                <strong>Note:</strong> You can disable cookies through your browser settings, but some
                ...
                <div class="bg-gradient-to-br from-emerald-50 to-white border border-emerald-200 rounded-xl p-8 mb-6">
                    <div class="flex flex-col md:flex-row items-center gap-6">
                        ...
                        <div>
                            ...
                            <p class="text-stone-700">
                                We do not store or process your payment card details directly. All transactions are securely
                                handled by trusted third-party payment gateways that comply with industry security
                                standards.
                            </p>
                            <div class="mt-4 p-4 bg-white rounded-lg border border-emerald-100">
                                <p class="text-sm text-emerald-800 font-medium">
                                    ...
                                    {{ \App\Helpers\SettingsHelper::get('store_name', 'Ved Herbs & Ayurveda') }} does not
                                    have access to your complete card or banking information.
                                </p>
                            </div>
                        </div>
                    </div>
            ...
            <section id="data-sharing" class="mb-16 scroll-mt-20">
                ...
                <div class="mb-8">
                    ...
                    <div class="space-y-4">
                        <div class="flex items-start gap-3 p-4 bg-white border border-stone-200 rounded-lg">
                            <iconify-icon icon="lucide:truck" width="20"
                                class="text-stone-500 mt-0.5 flex-shrink-0"></iconify-icon>
                            <div>
                        ...
                        <div class="flex items-start gap-3 p-4 bg-white border border-stone-200 rounded-lg">
                            <iconify-icon icon="lucide:banknote" width="20"
                                class="text-stone-500 mt-0.5 flex-shrink-0"></iconify-icon>
                            <div>
                        ...
                        <div class="flex items-start gap-3 p-4 bg-white border border-stone-200 rounded-lg">
                            <iconify-icon icon="lucide:scale" width="20"
                                class="text-stone-500 mt-0.5 flex-shrink-0"></iconify-icon>
                            <div>
                ...
                <div class="p-5 bg-stone-50 border border-stone-200 rounded-xl">
                    <p class="text-stone-700">
                        <strong>Important:</strong> All third parties are obligated to maintain confidentiality and data
                        security in compliance with our privacy standards.
                    </p>
                </div>
            </section>
            ...
            <section class="mb-16">
                ...
                <div class="grid md:grid-cols-3 gap-6 mb-8">
                    <div class="bg-white border border-blue-100 rounded-xl p-5 text-center">
                        ...
                        <p class="text-sm text-stone-600">Your data is stored on protected servers with restricted access
                        </p>
                    </div>
                ...
                <div class="bg-blue-50 border border-blue-200 rounded-xl p-6">
                    <div class="flex items-start gap-3">
                        <iconify-icon icon="lucide:alert-triangle" width="24"
                            class="text-blue-600 flex-shrink-0 mt-0.5"></iconify-icon>
                        <div>
                            <h4 class="font-semibold text-stone-900 mb-2">Security Disclaimer</h4>
                            <p class="text-stone-700">
                                We implement strict security measures to protect your personal information. However, no
                                method of transmission over the internet is 100% secure. We strive to protect your data but
            ...
            <section id="your-rights" class="mb-16 scroll-mt-20">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="flex items-start gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-stone-600">Request correction of any inaccurate or incomplete
                                    information</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-stone-600">Unsubscribe from promotional communications at any time
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="p-5 bg-white border border-green-200 rounded-xl">
                    <div class="flex items-start gap-3">
                        <iconify-icon icon="lucide:mail" width="20"
                            class="text-green-600 mt-0.5 flex-shrink-0"></iconify-icon>
                        <div>
                            <p class="text-stone-700">
                                To exercise these rights, please contact us using the details in the <a href="#contact"
                                    class="text-emerald-700 hover:text-emerald-800 font-medium">Contact Us</a> section
                                below.
                            </p>
                        </div>
                    </div>
            ...
            <section class="mb-16">
                ...
                <div class="bg-stone-50 border border-stone-200 rounded-xl p-6">
                    <p class="text-stone-700">
                        ...
                        {{ \App\Helpers\SettingsHelper::get('store_name', 'Ved Herbs & Ayurveda') }} is not responsible for
                        the privacy practices or content of those websites. We encourage you to read their privacy policies
                        separately.
                    </p>
                </div>
            </section>
            ...
            <section class="mb-16">
                ...
                <div class="bg-amber-50 border border-amber-100 rounded-xl p-6">
                    ...
                    <p class="text-stone-700 mb-4">
                        The information provided on our website is for educational and informational purposes only. Our
                    ...
                    <div class="bg-white border border-amber-200 rounded-lg p-4">
                        <p class="text-amber-800 font-medium">
                            ...
                            Please consult a qualified healthcare professional before using any product, especially if you
                            are pregnant, nursing, or have a medical condition.
                        </p>
                    </div>
                </div>
            </section>
            ...
            <section class="mb-16">
                ...
                <div class="bg-stone-50 border border-stone-200 rounded-xl p-6">
                    <p class="text-stone-700 mb-4">
                        {{ \App\Helpers\SettingsHelper::get('store_name', 'Ved Herbs & Ayurveda') }} reserves the right to
                        update or modify this Privacy Policy at any time without prior notice. Changes will be effective
                        immediately upon posting on this page.
                    </p>
                    <div class="flex items-start gap-3 p-4 bg-white rounded-lg border border-stone-200">
                        <iconify-icon icon="lucide:calendar" width="20"
                            class="text-stone-500 mt-0.5 flex-shrink-0"></iconify-icon>
                        <div>
                            <p class="text-stone-700">
                                <strong>We encourage you to review this policy periodically</strong> to stay informed about
            ...
            <section id="contact" class="scroll-mt-20">
                <div class="bg-gradient-to-br from-emerald-50 to-white border border-emerald-200 rounded-2xl p-8">
                    ...
                    <div class="grid md:grid-cols-3 gap-6">
                        <!-- Email -->
                        <a href="mailto:{{ \App\Helpers\SettingsHelper::get('store_email', 'support@vedherbsandayurveda.com') }}"
                            ...
                            <div
                                class="w-12 h-12 rounded-full bg-emerald-100 flex items-center justify-center mb-4 group-hover:bg-emerald-200 transition-colors">
                            ...
                            <p class="text-sm text-emerald-700 break-all max-w-full">
                                {{ \App\Helpers\SettingsHelper::get('store_email', 'support@vedherbsandayurveda.com') }}
                            </p>
                        </a>
                        ...
                        <a href="tel:{{ \App\Helpers\SettingsHelper::get('store_phone') }}"
                            ...
                            <div
                                class="w-12 h-12 rounded-full bg-emerald-100 flex items-center justify-center mx-auto mb-4 group-hover:bg-emerald-200 transition-colors">
                            ...
                            <h4 class="font-semibold text-stone-900 mb-2 flex justify-center items-center gap-2">
                                <iconify-icon icon="lucide:message-circle" width="16"
                                    class="text-emerald-600"></iconify-icon>
                                Phone / WhatsApp
                            </h4>
                            <p class="text-sm text-emerald-700">{{ \App\Helpers\SettingsHelper::get('store_phone') }}</p>
                        </a>
                        ...
                        <a href="{{ url('/') }}" target="_blank"
                            ...
                            <p class="text-sm text-emerald-700">{{ request()->getHost() }}</p>
                        </a>
                    </div>
                    ...
                    <div class="mt-8 pt-8 border-t border-emerald-200">
                        <div class="flex flex-col md:flex-row items-center justify-between gap-4">
                            ...
                            <div class="flex items-center gap-3">
                                <iconify-icon icon="lucide:calendar-days" width="20"
                                    class="text-emerald-600"></iconify-icon>
                                <div>
                            ...
                            <div class="text-center md:text-right">
                                <p class="text-sm text-stone-600 flex items-center justify-center md:justify-end gap-2">
                                    <iconify-icon icon="lucide:refresh-ccw" width="14"
                                        class="text-emerald-600"></iconify-icon>
                                    Last Updated: {{ date('F j, Y') }}
                                </p>
                                <p class="text-xs text-stone-500 mt-1">
                                    © {{ date('Y') }}
                                    {{ \App\Helpers\SettingsHelper::get('store_name', 'Ved Herbs & Ayurveda') }}. All rights
                                    reserved.
                                </p>
                            </div>
