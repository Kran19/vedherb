            ...
            <form id="login-form" class="space-y-6" method="POST" action="{{ route('customer.login.submit') }}">
                ...
                <div>
                    <div class="flex items-center justify-between mb-2">
                        ...
                        <a href="{{ route('customer.forgot-password') }}" class="text-sm text-emerald-700 hover:text-emerald-800">
                            Forgot password?
                        </a>
                    </div>
                    <div class="relative">
                ...
                <div class="relative">
                    ...
                    <div class="relative flex justify-center text-sm">
                        <span class="px-4 bg-white text-stone-500">Or continue with</span>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-2 gap-4">
                    {{-- <a href="{{ route('social.login', ['provider' => 'google']) }}"  --}}
                        <a
                       class="flex items-center justify-center gap-3 py-3 bg-white border border-stone-300 rounded-xl hover:bg-stone-50 transition-colors">
                    ...
                    {{-- <a href="{{ route('social.login', ['provider' => 'facebook']) }}"  --}}
                       ...
                       class="flex items-center justify-center gap-3 py-3 bg-white border border-stone-300 rounded-xl hover:bg-stone-50 transition-colors">
                        ...
                        <span class="text-sm font-medium text-stone-700">Facebook</span>
                    </a>
                </div>
                ...
                <div class="text-center pt-4">
                    <p class="text-stone-600">
                        ...
                        <a href="{{ route('customer.register') }}" class="font-semibold text-emerald-700 hover:text-emerald-800">
                            Sign up now
                        </a>
                    </p>
                </div>
