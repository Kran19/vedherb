        ...
        <div class="max-w-md mx-auto">
            ...
            <div class="bg-white rounded-2xl border border-stone-200 p-8 mb-8">
                ...
                <div class="text-center mb-8">
                    ...
                    <p class="text-stone-600">Enter your mobile number and we'll send you an OTP to reset your password.</p>
                </div>

                <!-- Form -->
                <form id="forgot-password-form" class="space-y-6" method="POST"
                    action="{{ route('customer.forgot-password.send-otp') }}">
                    @csrf
                    <!-- Mobile Number -->
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="text" name="mobile" value="{{ old('mobile') }}" required maxlength="10"
                                oninput="this.value = this.value.replace(/[^0-9]/g, '').slice(0, 10)" pattern="[0-9]{10}"
                                title="Please enter a valid 10-digit mobile number" autofocus
                    ...
                    <div class="text-center pt-4">
                        <a href="{{ route('customer.login') }}"
                            class="font-medium text-emerald-700 hover:text-emerald-800 flex items-center justify-center gap-2">
